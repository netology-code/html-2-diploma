...
8. [Вёрстка однотипных элементов](#Верстка-однотипных-элементов).
...
11. [Вёрстка текста, написанного заглавными буквами](#Верстка-текста-написанного-заглавными-буквами).
12. [Вёрстка декоративных линий у заголовков](#Верстка-декоративных-линий-у-заголовков).
13. [Вёрстка маски для изображений](#Верстка-маски-для-изображений).
14. [В HTML не должно быть пустых тегов](#В-HTML-не-должно-быть-пустых-тегов).
15. [Вёрстка отступов](#Верстка-отступов).
16. [Вёрстка иконок](#Верстка-иконок).
17. [Вёрстка скрытого текстового описания у полей ввода](#Верстка-скрытого-текстового-описания-у-полей-ввода).
